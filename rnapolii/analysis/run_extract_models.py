...
HA = AT.get_models_to_extract(analys_dir+'/selected_models_A_cluster'+str(c)+'_detailed.csv')
HB = AT.get_models_to_extract(analys_dir+'/selected_models_B_cluster'+str(c)+'_detailed.csv')
