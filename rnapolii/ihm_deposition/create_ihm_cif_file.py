...
output_directory = "test" #sys.argv[1]
...
#--------------------
num_frames = 100 #sys.argv[3]  # Number of frames in MC run
...
import ihm.dumper
with open('tutorial_output.cif', 'w') as fh:
